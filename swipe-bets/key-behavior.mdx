...
- **Right swipe (>50px)**: Places bet on the outcome
- **Left swipe (<-50px)**: Skips the card without betting
...
- **Frozen markets**: Show lock icon, disable betting
- **Removed from line**: Show lock icon, disable betting
...
- Auto-load next page when ≤3 cards remain
